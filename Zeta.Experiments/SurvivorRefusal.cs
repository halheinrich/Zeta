...
/// </para>
/// <para>
/// <b>Only a chart walk is ever refused this way.</b> A deep walk's cost moves with the last end
/// alone, so there is no cost knob to name that leaves the claim standing; ruling 5 on
/// <c>halheinrich/Math#64</c> caps its <c>Q</c> instead, which <see cref="SurvivorBound"/> records.
/// </para>
/// </remarks>
